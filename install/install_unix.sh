...
main() {
    ...
    setup_integration "$target_dir" "${1-false}" "$interactive"
    ...
    echo "  • Global command: truetrack (ensure ~/.local/bin is in your PATH)"
    ...
    echo ""
    echo "Tip: Run 'truetrack doctor' before your first start to check dependencies:"
    echo "  truetrack doctor"
    echo ""
